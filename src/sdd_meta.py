...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", type=str, default="./output_sdd/sdd1500full",
    ...
    parser.add_argument("--eval_every", type=int, default=1500,
...
def data_loader(args,tokenizer,caption_column="text",image_column="image"):
    ...
    tgt_dataset = load_dataset("imagefolder", data_dir="./dataset/target")
